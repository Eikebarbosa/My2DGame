...
public class CadastrarTela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        loginTextField.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1), "Crie seu login: "));
        ...
        senhaPasswordField.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1), "Crie sua senha:"));
    ...
    private void entrarButtonActionPerformed(java.awt.event.ActionEvent evt) {                                             
        ...
        try {
           Usuario usuario = new Usuario(loginTextField.getText(), new String(senhaPasswordField.getPassword()));
           UsuarioDAO date = new UsuarioDAO();
           
           if (date.existe(usuario)) {
